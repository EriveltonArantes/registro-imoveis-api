...
# 2. Listar registros
curl -H "Authorization: Bearer $TOKEN" http://localhost:8080/api/imovels
...
|----------|---------|---------|
| `/api/imovels` | GET / POST / PUT / DELETE | CRUD de Imovel |
| `/api/proprietarios` | GET / POST / PUT / DELETE | CRUD de Proprietario |
| `/api/atos` | GET / POST / PUT / DELETE | CRUD de Ato |
| `/api/certidaos` | GET / POST / PUT / DELETE | CRUD de Certidao |
